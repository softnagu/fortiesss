...
//                        .setAction("Action", null).show();
        ...
        not.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent cl = new Intent(Condition.this, Notification.class);
                startActivity(cl);
            }
        });
        call.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent cl = new Intent(Condition.this, Calling.class);
                startActivity(cl);
            }
        });
        bk.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent b = new Intent(Condition.this, MainActivity.class);
                startActivity(b);
    ...
    public void onBackPressed() {
        Intent bk = new Intent(Condition.this, MainActivity.class);
        startActivity(bk);
    }
}